...
## CORPUS
## Viz - WordCloud
## Lower Case (sometimes it should not be done)
## Remove punctuation !,@,%..
## Remove stop words 
## STEM
## DTM
## Sparse - remove sparse words
## Data Frame 
## Covert Column Names to R friendly
## Classification...
## 

# Read in the data
tweets = read.csv("./largeDataSets/socialMediaAnalytics/02_tweets.csv", stringsAsFactors=FALSE)
