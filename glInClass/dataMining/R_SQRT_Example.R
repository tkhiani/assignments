...
# No. of layers or neurons - sqrt(n), 
# important set of variables using logistic 
library("neuralnet")
...
traininginput <-  as.data.frame(runif(50, min=0, max=300))
...
net.sqrt <- neuralnet( formula = Output~Input, data = trainingdata, hidden=c(6,3), threshold=0.01 )
print(net.sqrt)
