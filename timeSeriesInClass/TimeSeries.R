...
Bond_Yield <- read.csv("./timeSeriesInClass/BondYield.csv")
head(Bond_Yield)
...
#################################
ChampagneCalc <- read.csv("./timeSeriesInClass/Champagne.csv")
...
######################
# Differencing
Clay_Bricks <- read.csv("./timeSeriesInClass/Clay Bricks.csv")
...
########## BASF ##########
German_Stock <- read.csv("./timeSeriesInClass/GermanMonthlyAverageStockPrice.csv")
